...
public class MainActivity extends ActionBarActivity {
    ...
    private void fetch() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                "https://googledrive.com/host/0B3o5-E3LmlWkYk4xR19SS1J1NUU" ,//jsonデータが有るサーバーのURLを指定します。0B3o5-E3LmlWkT2VhYlBZWGQ1b2s
                null,
    ...
    private List<MessageRecord> parse(JSONObject json) throws JSONException {
        ...
        for(int i =0; i < jsonMessages.length(); i++) {
            ...
            //jsonの値を取得します。
            int rank = jsonMessage.getInt("rank");
            String title = jsonMessage.getString("comment");
            String url = jsonMessage.getString("imageUrl");
            //jsonMessageを新しく作ります。
            MessageRecord record = new MessageRecord(rank, url, title);
